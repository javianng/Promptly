...
protocol OllamaServiceProtocol {
    func generateResponse(context: String, query: String) async throws -> AsyncThrowingStream<String, Error>
    func generateCompleteResponse(context: String, query: String) async throws -> OllamaGenerationResult
...
extension OllamaService {
    func generateResponseWithRetry(context: String, query: String, maxRetries: Int = AppConfig.Ollama.maxRetries) async throws -> AsyncThrowingStream<String, Error> {
        var lastError: Error?
